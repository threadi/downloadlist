<?php
/**
 * Tests for class \DownloadListWithIcons\Iconsets\Iconsets\Dashicons.
 *
 * @package download-list-block-with-icons
 */

namespace DownloadListWithIcons\Tests\Unit\Iconsets\Iconsets;

use DownloadListWithIcons\Tests\DownloadListTestCase;

/**
 * Object to test functions in the class \DownloadListWithIcons\Iconsets\Iconsets\Dashicons.
 */
class Dashicons extends DownloadListTestCase {
	/**
	 * The object.
	 *
	 * @var \DownloadListWithIcons\Iconsets\Iconsets\Dashicons
	 */
	private \DownloadListWithIcons\Iconsets\Iconsets\Dashicons $object;
	...
	public function set_up(): void {
		$this->object = new \DownloadListWithIcons\Iconsets\Iconsets\Dashicons();
	}
	...
	public function test_should_be_default(): void {
		...
		$this->assertTrue( $should_be_default );
	}
	...
	public function test_get_file_types(): void {
		...
		$this->assertNotEmpty( $file_types );
	}
