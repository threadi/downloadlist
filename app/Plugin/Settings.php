...
class Settings {
	...
	public function add_settings(): void {
		...
		$general_tab_info->set_title( __( 'Information', 'download-list-block-with-icons' ) );
		...
		// add setting.
		$download_button_setting = $settings_obj->add_setting( 'downloadlist_inherit_settings' );
		$download_button_setting->set_section( $tasks_tab_tasks );
		$download_button_setting->prevent_export( true );
		$field = new Button();
	...
	public function show_info(): void {
		echo '<p>' . esc_html__( 'Set the default settings for new download list blocks here. Under “Tasks,” you can also inherit these settings to all existing blocks.', 'download-list-block-with-icons' ) . '</p>';
	}
}
